...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 08, 2025 at 04:20 PM
...
INSERT INTO `customer` (`CUSTOMER_ID`, `CUSTOMER_NAME`, `EMAIL`, `PHONE`, `ADDRESS`, `PASSWORD`, `STATUS`, `usertype`) VALUES
(1, 'chirag', 'chirag1234@gmail.com', '+919924671', '', '$2y$10$Nn2QLp3zOG9NjQ10Q9AYT.sbpTpw/o2vUUfbxcvoGg0EUhGNso5Vq', 'inactive', 'customer'),
(2, 'lewis hamilton', 'lewisham@gmail.com', '9157091055', 'BRIDGETOWN ENGLAND', '$2y$10$jp2WI/hLRvuRKJrYiBhKKeE/LLN03Zmio9JVKWopCzUHsHmyZnJVW', 'inactive', 'customer'),
(3, 'HARSH SHANKHLA', 'harshshankhala99@gmail.com', '9157091055', '', '$2y$10$7t/E2YiwnOcQ3zr7mhGTh.Qy1XPfcpvoQY6jyYzHIGqDnZbVBiP4a', 'inactive', 'customer'),
(4, 'KRISHNA', 'KKS3457@gmail.com', '3453443434', '', '$2y$10$3Ht43xukLUyFL.VTWcQiouO72MJGV4fQYJTZVtP8t3IGXhJMsYiNO', 'inactive', 'customer'),
(5, 'BHEEM', 'bheem@gmail.com', '3453534534', '', '$2y$10$wY/faVpdehvo7OKxWsQ/7e6pty8wOzxwyx2CLUfVRcrk.JFSKmBpS', 'inactive', 'customer'),
(6, 'Thirth Shrimali', 'thirth@123gmail.com', '9913124353', '', '$2y$10$vAMyAWJBSJV2g4cjXKDo5OAUaDsBMKBtah2GiLE5Qp82rcMNZgH9O', 'inactive', 'customer'),
(7, 'Ash', 'familybokade176@gmail.com', '9928364926', '', '$2y$10$AtW5m5Lp.dG78KYO0po/r.xyqRJl/f6jYbQ5O4r3q8xIJ1uzqk/7.', 'inactive', 'customer'),
(8, 'Manoj', 'manoj123@gmail.com', '+918000696', '', '$2y$10$R2jWNXhwi157SmIy2lSirO/RoIAk9PJVzwDzVipz6HUD37gbqk4py', 'inactive', 'customer'),
(9, 'vimal', 'vimal@100gmail.com', '2342543453', '', '$2y$10$Jte9/j37vN3ByGH/5NoqZ.TucfRDxntbpgggth3L5BaW.xpdhZaRq', 'inactive', 'customer'),
(10, 'jonnie', 'jonnie@gmail.com', '9157091055', '', '$2y$10$Yuv3wTnlUkvkah4oOhbyiu3L6YxhDe2wvtIZToKa7aPXxXnGFL2mC', 'inactive', 'customer'),
(11, ' vibhuti mishra', 'vmishra@gmail.com', '3453534534', '', '$2y$10$2jwb4xieY6i/4XbQgJq5XOcONpyKirB.OTOI.WjkLDlpQQQvPeNvO', 'inactive', 'customer'),
(12, 'john rambo', 'johnrambo@gmail.com', '2352352342', '', '$2y$10$0f/.SCZIdR3BDuuo.TQt9.BIe2YCodqrvgguYz.lxR.XtHe6VWdHC', 'inactive', 'customer'),
(13, 'fernando alonso', 'fernando@gmail.com', '9157091055', 'A/30 MAURTI TENAMENT VASTRAL AHEMDABAD', '$2y$10$zJeZqiDLG74jY18JITjeleObU8l9dqojg50tfDL1SXO6UlzksGg6K', 'inactive', 'customer'),
(14, 'ramcharan', 'ramcharanc@gmail.com', '2837283323', 'A/79 MAURTI TENAMENT VASTRAL AHEMDABAD', '$2y$10$SZsi7/Q/oR.LMN97hlhAReFGBTV5OJ0ZUr/opcqQJz7SO1ez7cpuK', 'inactive', 'customer'),
(15, 'shinchan nohara', 'shinchan@gmail.com', '9157091017', 'A/77 BAJRANG KRUPA APPARTMENTS VASTRAL AHEMDABAD', '$2y$10$u5xSuMyOF0SBdhXCPY0FqOraKmNcikaWnMbHd6PFIQXNSRQx6wmKC', 'inactive', 'customer');
...
(1, 1, 'SUPER SALE', '2025-02-01', '2025-03-19', 15, 'AMAZING OFFER ON IPHONE', '/Project/uploads/IB161.jpg'),
(2, 5, 'SUPER DUPER SALE', '2025-02-01', '2025-03-01', 20, 'AMAZING OFFER ON REDMI K40', '/Project/uploads/BC1.jpg');
...
(1, 'IPHONE16', 1, 1, 69000.00, 'imgs/product/IB161.jpg'),
...
--
ALTER TABLE `product_details`
  MODIFY `PPID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `supplier`
  MODIFY `SUPPLIER_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=159;
